...
class MixerModulev6(BaseModule):
    def __init__(self,
        ...
        self.mix_transform = Sequential(nn.Linear(25, 25 * expand_ratio),
                                        build_norm_layer(norm_cfg, 25 * expand_ratio)[1],
                                        nn.GELU(),
                                        nn.Linear(25 * expand_ratio, 25))
...
class ViTMixAdapterv9(VisionTransformer):
    def __init__(self,
                 img_size=224,
                 patch_size=16,
                 in_channels=3,
                 ...
                 num_interactions=4,
                 interact_expand_ratio=4,
                 align_corners=False):
        super(ViTMixAdapterv9, self).__init__(img_size,
                                              patch_size,
                                              in_channels,
                                              embed_dims,
                                              num_layers,
        ...
        self.interact_expand_ratio = interact_expand_ratio
        ...
        self.adap_interactions = ModuleList(MixerModulev6(embed_dims,
                                                          ...
                                                          expand_ratio=interact_expand_ratio)
