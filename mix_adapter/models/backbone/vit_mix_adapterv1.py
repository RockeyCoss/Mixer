...
class ViTMixAdapterv1(VisionTransformer):
    def __init__(self,
                 img_size=224,
                 patch_size=16,
                 in_channels=3,
                 ...
                 num_interactions=4,
                 align_corners=False):
        super(ViTMixAdapterv1, self).__init__(img_size,
                                              patch_size,
                                              in_channels,
                                              embed_dims,
                                              num_layers,
        ...
        self.adap_merge_f16 = nn.Conv2d(embed_dims * 2, embed_dims, 1, 1)
    ...
    def forward(self, inputs):
        ...
        pyramid_features[1] = self.adap_merge_f16(torch.cat((pyramid_features[1],
                                                             vit_feature), dim=1))
