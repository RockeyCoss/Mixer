...
class MixerModulev4(BaseModule):
    def __init__(self,
                 num_channels=768,
                 norm_cfg=dict(type='LN', eps=1e-6, requires_grad=True),
                 dropout_layer=None,
                 init_cfg=None):
        super(MixerModulev4, self).__init__(init_cfg)
...
class ViTMixAdapterv15(VisionTransformer):
    def __init__(self,
                 img_size=224,
                 patch_size=16,
                 in_channels=3,
                 ...
                 num_interactions=4,
                 align_corners=False):
        super(ViTMixAdapterv15, self).__init__(img_size,
                                               patch_size,
                                               in_channels,
                                               embed_dims,
                                               num_layers,
        ...
        self.adap_interactions = ModuleList(MixerModulev4(embed_dims,
