...
class MixerModulev5(BaseModule):
    def __init__(self,
                 num_channels=768,
                 ...
                 ffn_expand=2.,
                 init_cfg=None):
        super(MixerModulev5, self).__init__(init_cfg)
        ...
        self.gamma_add = nn.Parameter(torch.zeros(1, num_channels, 1, 1))
    ...
    def forward(self, vit_feature, feature8, feature16, feature32):
        ...
        feature32 = self.ffn(nchw2nlc2nchw(self.f32_norm2,
                                           ...
                                           contiguous=True),
                             feature32)
        feature16 = feature16 + vit_feature * self.gamma_add
        return vit_feature, [feature8, feature16, feature32]


@BACKBONES.register_module()
class ViTMixAdapterv22(VisionTransformer):
    def __init__(self,
                 img_size=224,
                 patch_size=16,
                 in_channels=3,
                 ...
                 ffn_expand=2.,
                 align_corners=False):
        super(ViTMixAdapterv22, self).__init__(img_size,
                                               patch_size,
                                               in_channels,
                                               embed_dims,
                                               num_layers,
        ...
        self.adap_interactions = ModuleList(MixerModulev5(embed_dims,
